...
// uint16_t holdingRegisters[2]={5,10};
// uint16_t inputRegisters[2]={20,30};
UnbufferedSerial serialInterfaceMaster(PC_10,PC_11);
RS485 rs485Master(serialInterfaceMaster,PA_14,PA_15,9600);
int Modbus_RTUMasterExample::run()
{
  ...
  /********************Modbus RTU Master*************************/
  ModbusRTUMaster master(rs485Master);
  rtos::ThisThread::sleep_for(3s);

 /*                        Write Coil Function                                */
  bool bufCoils[2]={true,true};
